...
namespace AADS
{
    public partial class MainForm : Form
    {
        ...
        public event EventHandler<int> HideDelete;
        ...
        void mainMap_OnMarkerClick(GMapMarker item, MouseEventArgs e)
        {
            ...
            if (FixedPointList.Tag.Contains(Convert.ToInt32(currentMarkerTag.Tag)))
            {
                int idx = FixedPointList.Tag.IndexOf(Convert.ToInt32(currentMarkerTag.Tag));
        ...
        void mainMap_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            if (e.Button == MouseButtons.Left)
            {
                ...
                GlobalFixedPoint.LatLng = PositionConverter.ParsePointToString(pnew, "Signed Degree");
                GlobalFixedPoint.Lat = pnew.Lat;
                GlobalFixedPoint.Lng = pnew.Lng;

                FixedPointEventArgs args = new FixedPointEventArgs
                {
                    LatLng = GlobalFixedPoint.LatLng
                };
                FixedPointEvent handler = FixedPointEvent.Instance;
                handler.InvokeFixedPointChanged(args);
        ...
        // -> EDIT
        private void Handler_onFixedPointChanged(FixedPointEventArgs e)
        {
            // Just pass in
        }
        ...
        private void mainForm_Load(object sender, EventArgs e)
        {
            ...
            handler.onFixedPointChanged += Handler_onFixedPointChanged;
            //RaiseDelete += MainForm_RaiseDelete;
            //HideDelete += MainForm_HideDelete;
            MainFixedPoint.DeleteEvent += MainFixedPoint_DeleteEvent;
        ...
        {
            using (Views.FixedPoint.MainFixedPoint form = new Views.FixedPoint.MainFixedPoint())
            {
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            if (currentMarkerTag != null)
            {
                ...
                FixedPointList.Tag.Remove(Convert.ToInt32(currentMarkerTag.Tag));
                currentMarkerTag = null;
            }
        }
        private void MainFixedPoint_DeleteEvent(object sender, EventArgs e)
        {
            ...
            HideDelete?.Invoke(this, idx_toremove);
        }
    }
}
